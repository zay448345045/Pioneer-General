...
public class Messages {
    ...
    private static String[] prop_files = new String[]{
            "com.udawos.pioneer.actors.actors",
            "com.udawos.pioneer.items.items",
            "com.udawos.pioneer.levels.levels",
            "com.udawos.pioneer.plants.plants",
            "com.udawos.pioneer.scenes.scenes",
            "com.udawos.pioneer.ui.ui",
            "com.udawos.pioneer.windows.windows",
            "com.udawos.pioneer.misc.misc"
    };
    ...
    private static String get(Class c, String k, String baseName, Object...args){
        String key;
        if (c != null) {
            key = c.getName().replace("com.udawos.pioneer.", "");
            key += "." + k;
        } else
            key = k;
